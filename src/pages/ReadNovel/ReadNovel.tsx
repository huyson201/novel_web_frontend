...
const ReadNovel = () => {
    ...
    return (
        <>
            ...
            <div className='reading-page'>
                <div className="content-container">
                    <div className="page-head">
                        <div className="novel-title"><Link to={'#'}>Sổ tay công lược nữ thần</Link></div>
                        <div className="chapter-title">
                            <span className="chapter-number">Chương 1.</span>
                            Người ở rễ ôn gia
                        </div>
                        <div className="controls-btn">
                            <Button link className='btn btn-controls bg-light' disabled title='Chương trước' />
                            <Button link className='btn btn-controls bg-light' title='Chương Sau' />
                        </div>
                    </div>
                </div>
                <div className="content-container">
            ...
            <LeftNav show={showNav} onClickOutside={() => setShowNav(false)} />
        </>
